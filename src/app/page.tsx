...
// nova chamada, para listar todos os jogos:
  ...
  return (
    <main className="w-full">
      <Container>
          ...
          <section className="w-full bg-black rounded-lg">
            <div className="w-full max-h-96 h-96 relative rounded-lg">
              ...
              <Image
                ...
                quality={100}
                fill={true}
                className="max-h-96 object-cover rounded-lg opacity-50 hover:opacity-100 transition-all duration-700"
        ...
        <section className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-3">
          {data.map( (item) => (
